// ==UserScript==
// @name         Sequential Section Navigator V9.3 - SkillsLine Only with Enhanced Scenario Support
// @namespace    http://tampermonkey.net/
// @version      9.3
// @description  Navigate through noOutline sections on skillsline.com with enhanced scenario and sorting support
...
(function () {
  ...
  function waitForNextButton(element, category) {
    return new Promise((resolve) => {
      ...
      if (category === "scenario - auto continue with next wait") {
  ...
  console.log("✅ Sequential Section Navigator V9.3 loaded - SkillsLine Only with Enhanced Scenario Support");
})();